...
exports.focus = focus;
exports.mixin = mixin;
},{"vue":10}],6:[function(require,module,exports){
var Vue // late bind
...
exports.default = {
    props: ['item'],
    components: { FilamentHeader: FilamentHeader, FilamentColumns: FilamentColumns, FilamentFooter: FilamentFooter }
};
})()
if (module.exports.__esModule) module.exports = module.exports.default
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function(){with(this){return _h('div',{staticClass:"box",class:{featured:item.featured}},[_h('article',{staticClass:"media"},[_h('div',{staticClass:"media-left"},[_h('figure',{staticClass:"image is-128x128"},[_h('a',{attrs:{"href":'./assets/filament-images/'+item.id+'.png',"data-lity":""}},[_h('img',{attrs:{"src":'./assets/filament-images/'+item.id+'.png',"alt":'Image of '+item.brand+' '+item.product}})])])," ",_h('filament-footer',{attrs:{"item":item}})])," ",_h('div',{staticClass:"media-content"},[_h('div',{staticClass:"content"},[_h('filament-header',{attrs:{"item":item}})," ",_h('filament-columns',{attrs:{"item":item}})])])])])}}
...
},{"../partials/FilamentColumns.vue":19,"../partials/FilamentFooter.vue":20,"../partials/FilamentHeader.vue":21,"vue":10,"vue-hot-reload-api":6}],13:[function(require,module,exports){
;(function(){
'use strict';
...
exports.default = {
    ...
    computed: {
        filtered: function filtered() {
            ...
            searched.forEach(function (item) {
                if (that.matchingFilter(that.filter_material, item.material) && that.maximumFilter(that.filter_price, item.price_per_kg) && that.minimumFilter(that.filter_quality, Score.quality(item)) && that.minimumFilter(that.filter_strength, Score.pullStrength(item))) {
                    filtered.push(item);
                }
            });
            ...
            if (this.sort_mode === 'revchron') {
                ...
                sorted = this.closureSorter(filtered, function (f) {
                    return Score.quality(f);
                }).reverse();
            } else if (this.sort_mode === 'strength') {
                sorted = this.closureSorter(filtered, function (f) {
                    return Score.pullStrength(f);
                }).reverse();
    ...
    methods: {
        ...
        propSorter: function propSorter(items, prop) {
            var that = this;
            return items.sort(function (a, b) {
                if (that.dotNotation(a, prop) < that.dotNotation(b, prop)) return -1;
                if (that.dotNotation(a, prop) > that.dotNotation(b, prop)) return 1;
                return 0;
            });
        },
        closureSorter: function closureSorter(items, closure) {
            return items.sort(function (a, b) {
                if (closure(a) < closure(b)) return -1;
                if (closure(a) > closure(b)) return 1;
                return 0;
            });
        },
        revchronSorter: function revchronSorter(items) {
            return items.reverse();
        },
        featuredSorter: function featuredSorter(items) {
            if (this.search !== '' || this.featured == false) return items;
        ...
        dotNotation: function dotNotation(object, path) {
...
},{"../partials/CollectionEmpty.vue":18,"../partials/IntroSection.vue":22,"./FilamentSummary.vue":14,"vue":10,"vue-focus":5,"vue-hot-reload-api":6}],14:[function(require,module,exports){
;(function(){
'use strict';
...
exports.default = {
    ...
    computed: {
        ...
        pullStrength: function pullStrength() {
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function(){with(this){return _h('div',{staticClass:"box",class:{featured:item.featured}},[_h('article',{staticClass:"media"},[_h('div',{staticClass:"media-left"},[_h('figure',{staticClass:"image is-128x128"},[_h('a',{attrs:{"href":'./assets/filament-images/'+item.id+'.png',"data-lity":""}},[_h('img',{directives:[{name:"lazy",rawName:"v-lazy",value:('./assets/filament-images/'+item.id+'.png'),expression:"'./assets/filament-images/'+item.id+'.png'"}],attrs:{"alt":'Image of '+item.brand+' '+item.product}})])])])," ",_h('div',{staticClass:"media-content"},[_h('div',{staticClass:"content"},[_h('div',{staticClass:"columns is-desktop"},[_h('div',{staticClass:"column"},[_h('filament-header',{attrs:{"item":item}})," ",_h('div',{staticClass:"level"},[_h('div',{staticClass:"level-item has-text-centered"},[_m(0)," ",_h('p',{staticClass:"title"},[_s(item.price_per_kg||'n/a')+" €"])])," ",_h('div',{staticClass:"level-item has-text-centered"},[_m(1)," ",_h('p',{staticClass:"title"},[_s(quality)+"/20"])])," ",_h('div',{staticClass:"level-item has-text-centered"},[_m(2)," ",_h('p',{staticClass:"title"},[_s(pullStrength)])])," ",_h('div',{staticClass:"level-item has-text-centered"},[_m(3)," ",_h('p',{staticClass:"title"},[_s(item.ease_of_use?item.ease_of_use+'/5':'n/a')])])])])," ",_h('div',{staticClass:"column is-2-desktop"},[_h('filament-footer',{attrs:{"item":item}})])])])])])])}}
__vue__options__.staticRenderFns = [function(){with(this){return _h('p',{staticClass:"heading"},["Retail Price per kg"])}},function(){with(this){return _h('p',{staticClass:"heading"},["Overall Quality"])}},function(){with(this){return _h('p',{staticClass:"heading"},["Rated Strength"])}},function(){with(this){return _h('p',{staticClass:"heading"},["Ease of use"])}}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
...
},{"../partials/FilamentColumns.vue":19,"../partials/FilamentFooter.vue":20,"../partials/FilamentHeader.vue":21,"vue":10,"vue-hot-reload-api":6}],15:[function(require,module,exports){
'use strict';
...
var vm = new Vue({
    el: '#app',
    router: router,
    components: { HomeView: HomeView, AllView: AllView, FavouritesView: FavouritesView, InfoView: InfoView, PageHeader: PageHeader, PageNav: PageNav, PageFooter: PageFooter, Adsense: Adsense },
    data: {
        filaments: [],
        guide: [],
        countryCode: null
...
},{"../../node_modules/vue/dist/vue.js":11,"./partials/Adsense.vue":17,"./partials/PageFooter.vue":23,"./partials/PageHeader.vue":24,"./partials/PageNav.vue":25,"./score.js":26,"./views/AllView.vue":27,"./views/DetailView.vue":28,"./views/FavouritesView.vue":29,"./views/GuideView.vue":30,"./views/HomeView.vue":31,"./views/InfoView.vue":32,"fuse.js":1,"jquery":2,"lity":3,"vue-lazyload":7,"vue-resource":8,"vue-router":9}],16:[function(require,module,exports){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function(){with(this){return _h('div',{staticClass:"placement"},[(location === 'sidebar_left')?_h('div',[_m(0)]):_e()," ",(location === 'sidebar_right')?_h('div',[_m(1)]):_e()," ",(location === 'footer')?_h('div',[_m(2)]):_e()])}}
__vue__options__.staticRenderFns = [function(){with(this){return _h('ins',{staticClass:"adsbygoogle",attrs:{"style":"display:block","data-ad-client":"ca-pub-2111611078102983","data-ad-slot":"7250078958","data-ad-format":"auto"}})}},function(){with(this){return _h('ins',{staticClass:"adsbygoogle",attrs:{"style":"display:block","data-ad-client":"ca-pub-2111611078102983","data-ad-slot":"8587211353","data-ad-format":"auto"}})}},function(){with(this){return _h('ins',{staticClass:"adsbygoogle",attrs:{"style":"display:block;","data-ad-client":"ca-pub-2111611078102983","data-ad-slot":"6059220557","data-ad-format":"auto"}})}}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
...
},{"vue":10,"vue-hot-reload-api":6}],18:[function(require,module,exports){
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function(){with(this){return _m(0)}}
__vue__options__.staticRenderFns = [function(){with(this){return _h('div',{staticClass:"has-text-centered"},[_h('div',{staticClass:"title"},[_h('i',{staticClass:"fa fa-frown-o fa-3x"}),_h('br'),_h('br'),"\n        Nothing found!",_h('br')])," ",_h('div',{staticClass:"subtitle"},["\n        Try some different search terms or filters.\n    "])])}}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    ...
    hotAPI.rerender("data-v-13", __vue__options__)
  }
})()}
...
exports.default = {
    ...
    computed: {
        ...
        weightedStrength: function weightedStrength() {
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function(){with(this){return _h('div',{staticClass:"columns"},[_h('div',{staticClass:"column"},[_h('table',{staticClass:"table"},[_h('tr',[_m(0)," ",_h('td',[_h('b',[_s(item.price_per_kg?item.price_per_kg+' €':'n/a')])])])," ",_h('tr',[_m(1)," ",_h('td',[_h('b',[_s(item.ease_of_use?item.ease_of_use+'/5':'n/a')])])])," ",_h('tr',[_m(2)," ",_h('td',[_h('b',[_s(item.strength.misc.temperature_stability?item.strength.misc.temperature_stability+'/5':'n/a')])])])])," ",_h('table',{staticClass:"table"},[_h('tr',[_m(3)," ",_h('td',[_h('b',[_s(item.printer.nozzle_temp)+" °C"])])])," ",_h('tr',[_m(4)," ",_h('td',[_h('b',[_s(item.printer.bed_temp)+" °C"])])])," ",_h('tr',[_m(5)," ",_h('td',[_h('b',[_s(item.printer.bed_material)])])])," ",_h('tr',[_m(6)," ",_h('td',[_h('b',[_s(item.printer.fan)+" %"])])])])])," ",_h('div',{staticClass:"column"},[_h('table',{staticClass:"table"},[_h('tr',[_m(7)," ",_h('td',[_s(item.quality.threedbenchy)+"/5"])])," ",_h('tr',[_m(8)," ",_h('td',[_s(item.quality.overhangs)+"/5"])])," ",_h('tr',[_m(9)," ",_h('td',[_s(item.quality.details)+"/5"])])," ",_h('tr',[_m(10)," ",_h('td',[_s(item.quality.bridges)+"/5"])])," ",_h('tr',[_m(11)," ",_h('td',[_s(item.quality.warp)])])," ",_h('tr',{staticClass:"is-highlighted"},[_m(12)," ",_h('td',[_h('b',[_s(quality)+"/20"])])])])])," ",_h('div',{staticClass:"column"},[_h('table',{staticClass:"table"},[_h('tr',[_m(13)," ",_h('td',[_s(item.strength.bend.strength)+" kg"])])," ",_h('tr',[_m(14)," ",_h('td',[_s(item.strength.bend.adhesion)+" kg"])])," ",_h('tr',[_m(15)," ",_h('td',[_s(item.strength.pull.strength)+" kg"])])," ",_h('tr',[_m(16)," ",_h('td',[_s(item.strength.pull.adhesion)+" kg"])])," ",_h('tr',{directives:[{name:"show",rawName:"v-show",value:(item.strength.misc.bendflex),expression:"item.strength.misc.bendflex"}]},[_m(17)," ",_h('td',[_h('b',[_s(item.strength.misc.bendflex)+" mm"])])])," ",_h('tr',{directives:[{name:"show",rawName:"v-show",value:(item.strength.weighted),expression:"item.strength.weighted"}]},[_m(18)," ",_h('td',[_h('b',[_s(weightedStrength)+" kg"])])])," ",_h('tr',{staticClass:"is-highlighted"},[_m(19)," ",_h('td',[_h('b',[_s(pullStrength)])])])])])])}}
__vue__options__.staticRenderFns = [function(){with(this){return _h('td',["Retail Price per kg"])}},function(){with(this){return _h('td',["Ease of use"])}},function(){with(this){return _h('td',["Temperature stability"])}},function(){with(this){return _h('td',["Nozzle Temperature"])}},function(){with(this){return _h('td',["\n                    Print Bed Temperature\n                    ",_h('a',{attrs:{"href":"https://www.youtube.com/watch?v=eure74A9HNc","data-lity":""}},[_h('i',{staticClass:"fa fa-question-circle is-gray"})])])}},function(){with(this){return _h('td',["Print Bed Material"])}},function(){with(this){return _h('td',["Cooling Fan"])}},function(){with(this){return _h('td',["3D Benchy Score"])}},function(){with(this){return _h('td',["Overhangs"])}},function(){with(this){return _h('td',["Fine Details"])}},function(){with(this){return _h('td',["Bridges"])}},function(){with(this){return _h('td',["Warp"])}},function(){with(this){return _h('td',["Overall Quality"])}},function(){with(this){return _h('td',["Bend - Layer strength"])}},function(){with(this){return _h('td',["Bend - Layer adhesion"])}},function(){with(this){return _h('td',["Pull - Layer strength"])}},function(){with(this){return _h('td',["Pull - Layer adhesion"])}},function(){with(this){return _h('td',["Bend flex at 1kg load"])}},function(){with(this){return _h('td',["Weighted strength rating"])}},function(){with(this){return _h('td',["Pull Test Rating"])}}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    ...
    hotAPI.rerender("data-v-18", __vue__options__)
  }
})()}
},{"vue":10,"vue-hot-reload-api":6}],20:[function(require,module,exports){
;(function(){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function(){with(this){return _h('div',{staticClass:"control is-grouped is-vertical"},[_h('a',{staticClass:"button",class:{'is-info':isFavourite(item.id)},on:{"click":function($event){toggleFavourite(item.id)}}},[_m(0),"   ",_m(1)])," ",_h('router-link',{staticClass:"button",attrs:{"to":'/browse/'+item.id,"active-class":"is-hidden"}},[_m(2),"   ",_m(3)])," ",_h('a',{staticClass:"button",attrs:{"href":item.links.video,"data-lity":""}},[_m(4),"   ",_m(5)])," ",_h('a',{directives:[{name:"show",rawName:"v-show",value:(item.links.purchase),expression:"item.links.purchase"}],staticClass:"button",attrs:{"href":item.links.purchase,"target":"_blank"}},[_m(6),"   ",_m(7)])])}}
__vue__options__.staticRenderFns = [function(){with(this){return _h('i',{staticClass:"fa fa-star"})}},function(){with(this){return _h('b',["Star"])}},function(){with(this){return _h('i',{staticClass:"fa fa-search"})}},function(){with(this){return _h('b',["Details"])}},function(){with(this){return _h('i',{staticClass:"fa fa-play"})}},function(){with(this){return _h('b',["Video"])}},function(){with(this){return _h('i',{staticClass:"fa fa-shopping-cart"})}},function(){with(this){return _h('b',["Purchase online"])}}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    ...
    hotAPI.rerender("data-v-17", __vue__options__)
  }
})()}
},{"../mixins/ManagesFavourites.js":16,"vue":10,"vue-hot-reload-api":6}],21:[function(require,module,exports){
;(function(){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function(){with(this){return _h('div',{staticClass:"columns"},[_h('div',{staticClass:"column"},[_h('strong',{staticClass:"title"},[_s(item.brand+' '+item.product)])," ",_h('span',["("+_s(item.material)+")"])])," ",_h('div',{directives:[{name:"show",rawName:"v-show",value:(item.featured),expression:"item.featured"}],staticClass:"column is-one-quarter has-text-right"},[_m(0)])])}}
__vue__options__.staticRenderFns = [function(){with(this){return _h('b',{staticClass:"tag is-warning is-medium"},["Featured!"])}}]
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
...
},{"vue":10,"vue-hot-reload-api":6}],22:[function(require,module,exports){
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  if (!module.hot.data) {
    ...
    hotAPI.rerender("data-v-15", __vue__options__)
  }
})()}
},{"vue":10,"vue-hot-reload-api":6}],23:[function(require,module,exports){
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function(){with(this){return _m(0)}}
...
},{"vue":10,"vue-hot-reload-api":6}],24:[function(require,module,exports){
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function(){with(this){return _m(0)}}
...
},{"vue":10,"vue-hot-reload-api":6}],25:[function(require,module,exports){
;(function(){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function(){with(this){return _h('section',{staticClass:"section navsection"},[_h('div',{staticClass:"container"},[_h('div',{staticClass:"tabs is-centered"},[_h('ul',{staticClass:"is-left"},[_l((items),function(item,key){return _h('router-link',{attrs:{"to":key,"tag":"li","active-class":"is-active"}},[_h('a',[_s(item)])])})])])])])}}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"vue":10,"vue-hot-reload-api":6}],26:[function(require,module,exports){
"use strict";

module.exports = {
    quality: function quality(filament) {
        return filament.quality.threedbenchy + filament.quality.overhangs + filament.quality.details + filament.quality.bridges;
    },
    pullStrength: function pullStrength(filament) {
        return Math.round((Math.min(32 * 1.2, filament.strength.pull.strength * 1.5) + Math.min(32 * 1.2, filament.strength.pull.adhesion * 2)) / 0.6 * 2) / 2;
    },
    weightedStrength: function weightedStrength(filament) {
        return Math.round((Math.min(32, filament.strength.bend.strength * 2.5) + Math.min(32, filament.strength.bend.adhesion * 5) + Math.min(32, filament.strength.pull.strength * 1.5) + Math.min(32, filament.strength.pull.adhesion * 2)) * 2) / 2;
    }
};
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function(){with(this){return _h('filament-collection',{attrs:{"searchable":"1","filterable":"1","browseable":"1","featured":"1","items":filaments}})}}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"../components/FilamentCollection.vue":13,"vue":10,"vue-hot-reload-api":6}],28:[function(require,module,exports){
;(function(){
'use strict';
...
exports.default = {
    ...
    computed: {
        filament: function filament() {
            ...
            var filament = this.filaments.find(function (item) {
                return item.id === id;
            });
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function(){with(this){return _h('div',{staticClass:"container"},[_h('div',{staticClass:"control"},[_h('a',{staticClass:"button",on:{"click":function($event){$router.go(-1)}}},["\n            Go back\n        "])])," ",(filament)?_h('filament',{attrs:{"item":filament}}):_h('collection-empty')," "])}}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"../components/Filament.vue":12,"../partials/CollectionEmpty.vue":18,"vue":10,"vue-hot-reload-api":6}],29:[function(require,module,exports){
;(function(){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function(){with(this){return _h('filament-collection',{attrs:{"searchable":"0","filterable":"0","browseable":"1","featured":"0","items":favourites}})}}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
...
},{"../components/FilamentCollection.vue":13,"../mixins/ManagesFavourites.js":16,"vue":10,"vue-hot-reload-api":6}],30:[function(require,module,exports){
;(function(){
'use strict';
...
},{"vue":10,"vue-hot-reload-api":6}],31:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../components/FilamentCollection.vue":13,"vue":10,"vue-hot-reload-api":6}],32:[function(require,module,exports){
;(function(){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function(){with(this){return _h('div',{staticClass:"container"},[_h('div',{staticClass:"content"},[_m(0)," ",_m(1)," ",_m(2)," ",_m(3)," ",_m(4)," ",_m(5)," ",_m(6)," ",_m(7)," ",_m(8)," ",_h('p',["\n            There are currently "+_s(filaments.length)+" filaments on the site.\n            Stay tuned as more are added almost daily!\n        "])," ",_m(9)," ",_m(10)])])}}
...
},{"vue":10,"vue-hot-reload-api":6}]},{},[15]);
